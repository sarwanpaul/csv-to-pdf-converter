...
if (!defined('__CLASS_HTML2PDF__'))
{
	...
	require_once(dirname(__FILE__).'/_mypdf/mypdf.class.php');	// class mypdf extends fpdf
	require_once(dirname(__FILE__).'/parsingHTML.class.php');	// class for parsing HTML
	require_once(dirname(__FILE__).'/styleHTML.class.php');		// class for CSS Style

	global $HTML2PDF_TABLEAU;	$HTML2PDF_TABLEAU = array();	

	class HTML2PDF
	{
		var $langue			= 'fr';		// language
